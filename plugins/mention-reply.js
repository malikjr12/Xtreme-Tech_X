...
cmd({
  ...
  try {
    ...
    if (m.mentionedJid.includes(botNumber)) {
      const thumbnailRes = await axios.get(config.MENU_IMAGE_URL || "https://files.catbox.moe/yd9bnm.jpg", {
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "𝕏Ե®em£~Ե𝖊𝖈𝖍_𝕏",
            body: config.DESCRIPTION || "©Powered by 𝕏Ե®em£~Ե𝖊𝖈𝖍_𝕏😇",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://files.catbox.moe/yd9bnm.jpg", // Static image URL
